...
bool TauTauSelection::filter(edm::Event& event, const edm::EventSetup&) {
    ...
    //std::cout << "*****************" << std::endl;
    // General idea is to find tau particles (pdg id 15) and check if they are from the Z
    // Return true if two tau leptons come from a Z
    ...
    return lepton1==true && lepton2==true;
}
