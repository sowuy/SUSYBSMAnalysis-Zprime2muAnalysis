...
Zprime2muTriggerPathsAndFilters::Zprime2muTriggerPathsAndFilters(const edm::Event& event) {
  ...
  // if (!event.isRealData())                { path = "HLT_Mu45_eta2p1_v1",  filter = "hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered45e2p1Q", prescaled_path = "HLT_Mu24_eta2p1_v1", prescaled_filter = "hltL3fL1sMu20Eta2p1L1f0L2f10QL3Filtered24Q"; }
     if (!event.isRealData())                { path = "HLT_Mu50_v1",  filter = "hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered50Q", prescaled_path = "HLT_Mu27_v1", prescaled_filter = "hltL3fL1sMu25L1f0L2f10QL3Filtered27Q"; }
   ...
   // else if (run >= 250985)                 { path = "HLT_Mu50_v1", filter = "hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered50Q", prescaled_path = "HLT_Mu27_v1", prescaled_filter = "hltL3fL1sMu25L1f0L2f10QL3Filtered27Q"; } // at least until run 204601
  else if (run >= 250985)                 { path = "HLT_Mu45_eta2p1_v1", filter = "hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered45e2p1Q", prescaled_path = "HLT_Mu24_eta2p1_v1", prescaled_filter = "hltL3fL1sMu20Eta2p1L1f0L2f10QL3Filtered24Q"; }
  else
    valid = false;
}
