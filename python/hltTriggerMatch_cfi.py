...
muonTriggerMatchHLTMuons = cms.EDProducer('PATTriggerMatcherDRLessByR',
    ...
    matchedCuts           = cms.string('type("TriggerMuon") && (path("HLT_Mu9*",1,0) || path("HLT_Mu15*",1,0) ||  path("HLT_Mu24*",1,0) || path("HLT_Mu30*",1,0) || path("HLT_Mu40*",1,0) || path("HLT_Mu45*",1,0) || path("HLT_Mu50*",1,0))'),
...
#prescaled_trigger_paths = ['HLT_Mu24_eta2p1_v1']
