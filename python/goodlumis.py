...
last_prompt_run = 251883
last_run = 251883 #last DCS run or last analyzed run
...
Prompt_ll          = LumiList('/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/Cert_%i-%i_13TeV_PromptReco_Collisions15_JSON%s.txt'          % (first_run, last_prompt_run, prompt_version))
PromptMuonsOnly_ll = LumiList('/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/Cert_%i-%i_13TeV_PromptReco_Collisions15_JSON_MuonPhys%s_v4.txt' % (first_run, last_prompt_run, prompt_version))
