...
path = 'mc/ana_datamc_dy120.root'
tmp_fn = 'micro_ntuple.temp.txt'
#branch_spec = 'vertex_m'
branch_spec = 'run:lumi:event:vertex_m' # changed by Slava
cut = 'OurSel2012'
...
# colsize=10 is needed in order not to currupt the event number, changed by Slava
