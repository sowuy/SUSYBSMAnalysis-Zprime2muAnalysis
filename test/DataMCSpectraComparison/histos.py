...
process.source.fileNames =[#'file:./pat.root'
    '/store/mc/RunIIFall17MiniAODv2/ZToMuMu_NNPDF31_13TeV-powheg_M_6000_Inf/MINIAODSIM/PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/90000/7C6A92E6-D544-E811-B317-0CC47A4D766C.root',
...
#        ('WWinclusive', '/WWTo2L2Nu_NNPDF31_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14_ext1-v1/MINIAODSIM'),
...
# 
         ...
         ('dyInclusive50_ext', '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14_ext1-v1/MINIAODSIM'),
# 
...
#         ('ttbar_lep', '/TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'),
...
# 
#         ('antitopW', '/ST_tW_antitop_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'),
#         ('tW', '/ST_tW_top_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'),
# 
...
#                pobj = process.DYGenMassFilter * pobj
#            
# re run WWinclusive with the filteronce the binned in mass samples are ready
...
def for_mc(process, fill_gen_info=True):
    process.GlobalTag.globaltag ='94X_mc2017_realistic_v12' # Run 2017E #change line 52
...
config = config()
config.General.requestName = 'ana_datamc_%(name)s_20181209'
...
'''
    ...
    if 'no_data' not in sys.argv:
        ...
        dataset_details = [
                ('SingleMuonRun2017B-17Nov2017-v1', '/SingleMuon/Run2017B-17Nov2017-v1/MINIAOD'),
                ('SingleMuonRun2017C-17Nov2017-v1', '/SingleMuon/Run2017C-17Nov2017-v1/MINIAOD'),
                ('SingleMuonRun2017D-17Nov2017-v1', '/SingleMuon/Run2017D-17Nov2017-v1/MINIAOD'),
                ('SingleMuonRun2017E-17Nov2017-v1', '/SingleMuon/Run2017E-17Nov2017-v1/MINIAOD'),
                ('SingleMuonRun2017F-17Nov2017-v1', '/SingleMuon/Run2017F-17Nov2017-v1/MINIAOD'),
            ]
