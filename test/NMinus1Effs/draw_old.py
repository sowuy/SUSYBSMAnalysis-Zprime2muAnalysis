...
raw_samples50m120 = [dy50to120_s,ttbar_pow,ww_incl,zz_incl,wz,wjets,tWtop,tWantitop,qcd50to80,qcd80to120,qcd170to300,qcd300to470,qcd470to600,qcd800to1000,qcd1000to1400,qcd1400to1800,qcd1800to2400,qcd3200]#,inclmu15]
raw_samples120m = [dy120to200_s,dy200to400_s,dy400to800_s,dy800to1400_s,dy1400to2300_s,dy2300to3500_s,dy3500to4500_s,dy4500to6000_s,ww_incl,zz_incl,wz,wjets,tWtop,tWantitop,qcd50to80,qcd80to120,qcd170to300,qcd300to470,qcd470to600,qcd800to1000,qcd1000to1400,qcd1400to1800,qcd1800to2400,qcd3200]#inclmu15,dy6000_s,
...
# All MC samples
# lumi
mcsum_lumi.prepare_histos_sum(raw_samples,lumiBCD)
mc_samples_lumi = [nm1entry(sample,False,lumiBCD) for sample in raw_samples]
...
mc_samples_lumi = [nm1entry(sample,False,lumiBCD) for sample in raw_samples50m]
for mc_sample in mc_samples_lumi:
    exec '%s = mc_sample' % mc_sample.name
# ref
#mc50m_ref.prepare_histos_sum(raw_samples50m, nolumi)
#mc_samples_ref = [nm1entry(sample,False,nolumi) for sample in raw_samples50m]
#for mc_sample in mc_samples_ref:
#    exec '%s = mc_sample' % mc_sample.name
#
# 50 < m < 120 GeV
...
mc_samples_lumi = [nm1entry(sample,False,lumiBCD) for sample in raw_samples50m120]
for mc_sample in mc_samples_lumi:
    exec '%s = mc_sample' % mc_sample.name
# ref
...
mc_samples120m_lumi = [nm1entry(sample,False,lumiBCD) for sample in raw_samples120m]
for mc_sample in mc_samples120m_lumi:
    exec '%s = mc_sample' % mc_sample.name
# ref
...
## 800 < m < 2300 GeV
## lumi
#mc800m2300_lumi.prepare_histos_sum(raw_samples800m2300, lumiBCD)
#mc_samples800m2300_lumi = [nm1entry(sample,False,lumiBCD) for sample in raw_samples800m2300]
...
## 400 < m < 2300 GeV
## lumi
#mc400m2300_lumi.prepare_histos_sum(raw_samples400m2300, lumiBCD)
#mc_samples800m2300_lumi = [nm1entry(sample,False,lumiBCD) for sample in raw_samples800m2300]
#for mc_sample in mc_samples800m2300_lumi:
#    exec '%s = mc_sample' % mc_sample.name
## ref 
...
#    '120m_BCD':   [dataB,dataCD,mc120m_ref],
    '120m':   [dataBCD,mc120m_lumi],
    '60m120':   [dataBCD,mc50m120_lumi],
...
def print_CP_eff(y,eyl,eyh,name):
    print name
...
for name, mass_range in mass_ranges:
    ...
    for entry in to_use[name]:
        ...
        print_CP_eff(y,eyl,eyh,entry.name)
